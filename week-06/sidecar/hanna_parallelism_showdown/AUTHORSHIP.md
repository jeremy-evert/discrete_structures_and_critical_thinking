...
- Ran the selected 24-worker benchmark twice. The final fresh result has 18 finite, unique CPU rows through 20,000,000 values and no stale append data. The helper's sandbox invocation failed safely at the `nvcc` preflight without modifying CPU evidence. Published the accepted extended payload as `216803d4a9cb88b9b64671eca04fab33703444c8` to `origin/main`.
